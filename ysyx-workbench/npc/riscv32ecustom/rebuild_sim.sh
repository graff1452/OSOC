...
verilator -cc --exe --build -Mdir build --top-module minirv --trace-fst \
  vsrc/templates.v vsrc/lfsr8.v vsrc/ifu.v vsrc/decoder.v vsrc/regfile.v vsrc/alu.v vsrc/lsu.v vsrc/arbiter.v vsrc/xbar.v vsrc/uart.v vsrc/clint.v vsrc/axi_mem.v vsrc/minirv.v \
  csrc/main.cpp \
