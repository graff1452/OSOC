// Step 7: this was axi_mem_d.v (data-only) through step 6. As of the
// arbiter, it's the ONE shared memory for both instructions and data --
// nothing inside this module needed to change, since it was already a
// full read-write AXI4-Lite SRAM with random response delay; only its
// name and what's wired to it (the arbiter, not lsu.v directly) changed.
// axi_mem_i.v is retired -- no longer instantiated anywhere.
module axi_mem
(
  input         clk,
  input         rst,
